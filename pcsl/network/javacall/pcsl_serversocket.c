    ...
    void **pHandle)
{
    ...
    res = javacall_server_socket_open_start(JAVACALL_CONFIGURATION_NOT_SPECIFIED, JAVACALL_IP_VERSION_4, port, pHandle, &Context);
...
int pcsl_sereversocket_close_start(
    ...
    void **pContext)
{
  return javacall_to_pcsl_result (javacall_socket_close_start (handle, JAVACALL_TRUE, pContext));
}
