...
void NativeGenerator::generate_native_math_entries() {
  ...
  RegisterSet LowTarget2  = set(r2);
  RegisterSet HighTarget2 = set(r3);
  ...
  // Where the third item popped off the stack goes
  RegisterSet C = JavaStackDirection < 0 ?  LowTarget2  : HighTarget2;
  // Where the fourth item popped off the stack goes
  RegisterSet D = JavaStackDirection < 0 ?  HighTarget2 : LowTarget2;
