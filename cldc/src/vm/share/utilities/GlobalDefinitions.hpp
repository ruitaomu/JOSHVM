...
extern int   jvm_snprintf(char *str, size_t sizeOfBuffer, const char *format, ...);
...
#if ARM_EXECUTABLE && ENABLE_ZERO_YOUNG_GENERATION && !ENABLE_ARM_V7 && !ENABLE_THUMB_COMPILER
