...
ifeq ($(ENABLE_RVDS), true)
	...
	# Temp: supress #61-D: integer operation result is out of range
    CPP_DEF_FLAGS	+= --diag_suppress 61
...
CPP_DEF_FLAGS	       += -DARM=1 $(APCS_FLAGS)
...
print_config:
	...
	$(A)echo "ENABLE_FLOAT	   = $(ENABLE_FLOAT)"
	$(A)echo "ENABLE_SOURCE_GENERATORS = $(ENABLE_SOURCE_GENERATORS)"
	$(A)echo "ENABLE_RVDS	   = $(ENABLE_RVDS)"
	$(A)echo "ENABLE_ARM_VFP	   = $(ENABLE_ARM_VFP)"
	$(A)echo "=========================================="
endif
