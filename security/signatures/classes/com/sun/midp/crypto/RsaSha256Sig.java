...
/**
 * Implements RSA SHA256 Signatures.
 */ 
public final class RsaSha256Sig extends Signature {
    /**
     ...
     *
     * @exception RuntimeException if SHA-256 is not available
     */
    public RsaSha256Sig() {
        try {
            rsaSig =
                new RSASig(PREFIX_SHA256, MessageDigest.getInstance("SHA-256"));
