...
public abstract class ProtocolBase implements MessageConnection,
    ...
    /**************
     ** STUB!!! As temp solution to replace MidletSuite.UNUSED_SUITE_ID
     **
     **************/
	protected final static int UNUSED_SUITE_ID = 0;
	...
	protected int getSuiteID() {
		/**************
		**
		**  STUB!! To replace MidletSuite.getSuiteID() as temp solution.
		**
		***************/
