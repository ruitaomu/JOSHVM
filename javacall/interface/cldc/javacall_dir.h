 ...
 * @param isHidden will be the "hidden" property of the next file in directory
 * @param isDirectory will be true if the next file is directory, false for regular
 *        file
 * 
