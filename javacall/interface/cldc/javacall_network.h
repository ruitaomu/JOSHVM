...
typedef javacall_int32 javacall_configuration_id;
#define JAVACALL_CONFIGURATION_NOT_SPECIFIED (-1)

/**
 * Performs platform-specific initialization of the networking system.
 * Will be called when begin to use network.
 *
 ...
 * @param id of the connection configuration, possible value is
 *        JAVACALL_CONFIGURATION_NOT_SPECIFIED
 ...
 * @retval JAVACALL_FAIL    fail
 */
javacall_result /*OPTIONAL*/ javacall_network_finalize_start(void);
 ...
 * @retval JAVACALL_FAIL    fail
 */
javacall_result /*OPTIONAL*/ javacall_network_finalize_finish(void);
...
/**
 * Gets the http / https proxy address.
 *
