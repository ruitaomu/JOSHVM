...
/**
 * @def JAVACALL_MULTISIM_SUBSCRIBER_DEFAULT
 * default subscriber slot number
 */
#define JAVACALL_MULTISIM_SUBSCRIBER_DEFAULT 0
...
/**
 * Initialize SMS system. Will be called ONCE when VM start.
 */
void javacall_sms_init(void);

/**
 * Deinitialize SMS system. Will be called ONCE when VM finish.
 */
void javacall_sms_deinit(void);
    
/**
 * send an SMS message via particular subscriber
 *
 * @param subscriber_slot the subscriber slot number for MultiSim devices or
 *                     JAVACALL_MULTISIM_SUBSCRIBER_DEFAULT for SingleSIM device
...
/**
 * send an SMS message without port via particular subscriber
 *
 * @param subscriber_slot the subscriber slot number for MultiSim devices or
 *                     JAVACALL_MULTISIM_SUBSCRIBER_DEFAULT for SingleSIM device
 * @param msgType message string type: Text or Binary.
