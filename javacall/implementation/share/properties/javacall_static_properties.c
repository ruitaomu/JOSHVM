...
static char* javacall_static_properties_application_keys[] = {
    ...
    "org.bouncycastle.pkcs1.not_strict",
    NULL
};
...
static char* javacall_static_properties_internal_keys[] = {
    ...
    "system.jam_space",
    "VmDebuggerPort",
    "logging.level.channel.NONE",
    "logging.level.channel.AMS",
    "logging.level.channel.CORE",
    "logging.level.channel.LOWUI",
    "logging.level.channel.HIGHUI",
    "logging.level.channel.PROTOCOL",
    "logging.level.channel.NETWORK",
    "logging.level.channel.SOCKET",
    "logging.level.channel.RMS",
    "logging.level.channel.SECURITY",
    "logging.level.channel.SERVICES",
    "logging.level.channel.STORAGE",
    "logging.level.channel.PUSH",
    "logging.level.channel.MMAPI",
    "logging.level.channel.VSCL",
    "logging.level.channel.MIDPSTRING",
    "logging.level.channel.MALLOC",
    "logging.level.channel.CORE_STACK",
    "logging.level.channel.I18N",
    "logging.level.channel.HIGHUI_ITEM_LAYOUT",
    "logging.level.channel.HIGHUI_ITEM_REPAINT",
    "logging.level.channel.HIGHUI_FORM_LAYOUT",
    "logging.level.channel.HIGHUI_ITEM_PAINT",
    "logging.level.channel.TOOL",
    "logging.level.channel.JSR180",
    "logging.level.channel.EVENTS",
    "logging.level.channel.LC_MAX",
    "LOG_INFORMATION",
    "LOG_WARNING",
    "LOG_ERROR",
    "LOG_CRITICAL",
    ...
    "DISPLAY_NUM_COLOR",
    "ALPHA_LEVELS",
    "system.network.pdp.apn",
    "system.network.pdp.authtype",
    "system.network.pdp.username",
    "system.network.pdp.password",
    NULL
};
