...
/**
 * dest: ptr to dest buffer
 * source: ptr to src buffer
 * nchars: limit number of wchars to be copied
 * return: The actural number (not including null terminated wchar) of wchars have been copied
 **/
int javautil_wcsncpy(unsigned short* dest, unsigned short* source, size_t nchars);
int javautil_wcslen(const unsigned short* string);
