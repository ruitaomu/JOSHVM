...
public class Attrs implements Parser.Attrs
	, org.xml.sax.ext.Attributes2
{
	...
	private void update()
	{
		...
		final boolean withns = (mElm.id & Parser.FLAG_NSAWARE) != 0;
		/* The list will ... not
		...
		for (Pair attr = mElm.list; attr != null; attr = attr.next) {
			// check if attribute is NS declaration
			if (withns && attr.list != null)  // NS declaration
	 ...
	 *	appear in the list.
	 */
	public int getIndexNullNS(String uri, String localName)
	{
		if (mLength < 0)
			update();
